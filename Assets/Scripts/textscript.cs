...
//{
//    // static은 npc가 1명이라면 상관없지만 
//    // 여러명이라면 static을 하면 안됨
//    // 부모 class로 text_log_Base를 만들고 
//    // 자식 obj에 text_log를 다 넣고 함수로 override하는 방식으로 해야함
//    static public int npc_talk_int = 0;
//    // Bool은 C#이지만 Boolen은 System. 언어임 사용 방식이 다름
//    // justOne은 npc_talk_int 조건이 한 번만 실행되도록 막기 위해 사용된 플래그
